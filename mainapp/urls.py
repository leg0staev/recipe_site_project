...
from .views import MainRecipeListView, RecipeDetailView, RegisterView, RegistrationSuccessView, LogoutSuccessView, \
    AllRecipesView, RecipeCreateView, RecipeUpdateView
